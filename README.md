# FishingHelper
This is a program in progress that will allow users to be able to be given the fishing locations in their state. The user will be given the various locations in their state that are registered as fishing locations, and the distance between them and that fishing spot.

## The Code

Before I begin to break down the code I need to display the code we will be breaking down. This is the file found in the src folder, and will go through some revisions as I begin to work on it over time.
